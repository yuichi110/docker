...
# Move SSH keys and config
mkdir -p /var/jenkins_home/.ssh
chmod 0600 /tmp/id_rsa
mv /tmp/id_rsa /var/jenkins_home/.ssh/
chmod 0644 /tmp/id_rsa.pub
mv /tmp/id_rsa.pub /var/jenkins_home/.ssh/
chmod 0644 /tmp/config
mv /tmp/config /var/jenkins_home/.ssh/
